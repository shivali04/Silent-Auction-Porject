<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Userregistration.aspx.cs" Inherits="ProjectRegistration.Userregistration" %>
        ...
        <div>
            ...
            <table style="width: 100%;">
                <caption class="style3">
                    <h1 style="color: brown"><strong>Registration Form </strong></h1>
                    <br />
                </caption>
                <tr>
                    <td class="style1"></td>
                ...
                <tr>
                    ...
                    <td class="style2">
                        <asp:TextBox ID="txtpass" runat="server" Height="22px" MaxLength="20"
                            Width="236px" TextMode="Password"></asp:TextBox>
                    </td>
                    <td>
